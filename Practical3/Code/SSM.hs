module SSM where
-- Types and utilities for representing SSM programs
...
data Instr 
 ...
 | NEG | NOT                                		-- Bitwise      operations on 1 stack operand
...
-- Offsets computations needed for jumps
codeSize :: Code -> Int
